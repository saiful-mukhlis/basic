...
//			App.info(komponent.getIcon32());
			setButton(db, b, komponent.getTitle(), komponent.getIcon32());
...
//		
	...
	private void setButton(ODatabaseDocumentTx db,JButton tb,String label, Icon icon32){
		tb.setText(label);
	...
	public void changeHakAkses() {
		int i=0;
		butons.get(i++).setEnabled(UsrM.VIEW);
		butons.get(i++).setEnabled(GrpM.VIEW);
