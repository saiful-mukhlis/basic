...
//	}
	...
	public void appendTa( String i8n, Component c,int x, int y, int w,int h){
		addLabel(App.getT(i8n), cc.xy(x, y+1));
		add(c, cc.xywh(x+2, y, w, h));
	}
...
//	}
	...
	public void append(Component c,int x, int y, int w, int h){
		add(c, cc.xywh(x, y, w,h));
	}
