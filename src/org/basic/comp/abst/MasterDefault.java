...
//	}
	public void actionAdd() {
		...
		d.setVisible(true);
		table.getTable().addRowSelectionInterval(table.getTableModel().getRowCount()-1, table.getTableModel().getRowCount()-1);
		table.selected();
	}
	@Override
...
//	}
	...
	public void requestDefaultSelected() {
		if (table!=null) {
			table.getTable().addRowSelectionInterval(0, 0);
			table.selected();
		}
	}
